...
export const authCodeConfirmationMail = async (options: {
  ...
  <h4 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Welcome to ${config.datasite.name}</h4>

  <span style="font-size:16px">
  You recieve this email because you send a request to us. If you didn't, kindly delete this or please copy the code below to confirm your email thanks!
  </span><br/><br/>

  <table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation">

  <span style="font-size:16px"> 
    <strong> <a> ${code} </a> </strong>
